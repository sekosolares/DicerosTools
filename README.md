...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/capulusnoctis/DicerosTools@1.1.2/diceros-tools.js"></script>
```

o bien:

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/capulusnoctis/DicerosTools@1.1.2/diceros-tools.min.js"></script>
```
